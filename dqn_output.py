...
import numpy as np
import torch
from agent.selfrule.agent1 import Agent
...
if __name__ == "__main__":
    ...
    fighter_model.load("model/simple/model_0000"+"053"+"00.pkl")
    # fighter_model.load("model/simple/model_01.pkl")
    # execution
        ...
        while True:
            ...
            for y in range(red_fighter_num):
                ...
                if red_obs_dict['fighter'][y]['alive']:
                    ...
                    #tmp_img_obs_1 = torch.unsqueeze(torch.FloatTensor(tmp_img_obs), 0)
                    #tmp_info_obs_1 = torch.unsqueeze(torch.FloatTensor(tmp_info_obs), 0)
