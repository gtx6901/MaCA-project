...
export EXP_NAME="${EXP_NAME:-mappo_maca_4060_library_long_${RUN_ID}}"
export DEVICE="${DEVICE:-gpu}"
export TOTAL_ENV_STEPS="${TOTAL_ENV_STEPS:-12000000}"
export NUM_ENVS="${NUM_ENVS:-4}"
export NUM_WORKERS="${NUM_WORKERS:-2}"
export ROLLOUT="${ROLLOUT:-96}"
export PPO_EPOCHS="${PPO_EPOCHS:-3}"
export LEARNING_RATE="${LEARNING_RATE:-3e-4}"
export HIDDEN_SIZE="${HIDDEN_SIZE:-192}"
