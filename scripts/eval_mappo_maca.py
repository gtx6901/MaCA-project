...
def build_env(train_cfg: dict, args) -> MAPPOMaCAEnv:
    ...
    return MAPPOMaCAEnv(
        MAPPOMaCAConfig(
            ...
            boundary_penalty_margin=float(train_cfg.get("maca_boundary_penalty_margin", 120.0)),
            boundary_penalty_scale=float(train_cfg.get("maca_boundary_penalty_scale", 0.01)),
            ...
            priority_evidence_weight=float(train_cfg.get("maca_priority_evidence_weight", 1.0)),
            priority_uncertainty_weight=float(train_cfg.get("maca_priority_uncertainty_weight", 0.9)),
            priority_diffusion_weight=float(train_cfg.get("maca_priority_diffusion_weight", 0.7)),
            priority_crowding_penalty=float(train_cfg.get("maca_priority_crowding_penalty", 0.45)),
            priority_assignment_penalty=float(train_cfg.get("maca_priority_assignment_penalty", 0.35)),
            priority_distance_penalty=float(train_cfg.get("maca_priority_distance_penalty", 0.25)),
            priority_unseen_cap_steps=int(train_cfg.get("maca_priority_unseen_cap_steps", 40)),
            priority_memory_decay=float(train_cfg.get("maca_priority_memory_decay", 0.92)),
            priority_diffusion_rate=float(train_cfg.get("maca_priority_diffusion_rate", 0.25)),
            priority_passive_recv_weight=float(train_cfg.get("maca_priority_passive_recv_weight", 0.25)),
            priority_known_enemy_boost=float(train_cfg.get("maca_priority_known_enemy_boost", 0.8)),
            priority_unseen_threshold=float(train_cfg.get("maca_priority_unseen_threshold", 0.7)),
