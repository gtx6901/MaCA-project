...
def build_env(args, seed_offset: int) -> MAPPOMaCAEnv:
    ...
    return MAPPOMaCAEnv(
        MAPPOMaCAConfig(
            ...
            search_progress_aux_scale=args.maca_search_progress_aux_scale,
            reacquire_success_bonus=args.maca_reacquire_success_bonus,
            post_contact_no_contact_penalty=args.maca_post_contact_no_contact_penalty,
            post_contact_no_contact_grace=args.maca_post_contact_no_contact_grace,
            isolation_penalty_scale=args.maca_isolation_penalty_scale,
            finish_sweep_stall_penalty=args.maca_finish_sweep_stall_penalty,
            team_reacquire_success_bonus=args.maca_team_reacquire_success_bonus,
            team_post_contact_no_contact_penalty=args.maca_team_post_contact_no_contact_penalty,
            team_post_contact_no_contact_grace=args.maca_team_post_contact_no_contact_grace,
            team_isolation_penalty=args.maca_team_isolation_penalty,
            team_overexpand_penalty=args.maca_team_overexpand_penalty,
            team_finish_stall_penalty=args.maca_team_finish_stall_penalty,
            opening_max_expand_radius=args.maca_opening_max_expand_radius,
            contact_max_expand_radius=args.maca_contact_max_expand_radius,
            reacquire_max_expand_radius=args.maca_reacquire_max_expand_radius,
            finish_max_expand_radius=args.maca_finish_max_expand_radius,
            opening_max_support_dist=args.maca_opening_max_support_dist,
            contact_max_support_dist=args.maca_contact_max_support_dist,
            reacquire_max_support_dist=args.maca_reacquire_max_support_dist,
            finish_max_support_dist=args.maca_finish_max_support_dist,
            assignment_support_speed_norm=args.maca_assignment_support_speed_norm,
            assignment_max_support_time=args.maca_assignment_max_support_time,
            assignment_hard_slack=args.maca_assignment_hard_slack,
            assignment_distance_cost=args.maca_assignment_distance_cost,
            assignment_crowding_cost=args.maca_assignment_crowding_cost,
            assignment_support_cost=args.maca_assignment_support_cost,
            assignment_support_time_cost=args.maca_assignment_support_time_cost,
            assignment_expand_cost=args.maca_assignment_expand_cost,
            opening_priority_uncertainty_mult=args.maca_opening_priority_uncertainty_mult,
            contact_priority_uncertainty_mult=args.maca_contact_priority_uncertainty_mult,
            reacquire_priority_uncertainty_mult=args.maca_reacquire_priority_uncertainty_mult,
            finish_priority_uncertainty_mult=args.maca_finish_priority_uncertainty_mult,
            opening_priority_known_enemy_mult=args.maca_opening_priority_known_enemy_mult,
            contact_priority_known_enemy_mult=args.maca_contact_priority_known_enemy_mult,
            reacquire_priority_known_enemy_mult=args.maca_reacquire_priority_known_enemy_mult,
            finish_priority_known_enemy_mult=args.maca_finish_priority_known_enemy_mult,
            reacquire_event_min_gap=args.maca_reacquire_event_min_gap,
            finish_sweep_enemy_threshold=args.maca_finish_sweep_enemy_threshold,
            ...
            terminal_survivor_penalty=args.maca_terminal_survivor_penalty,
            terminal_timeout_survivor_penalty=args.maca_terminal_timeout_survivor_penalty,
            terminal_total_win_bonus=args.maca_terminal_total_win_bonus,
        )
    )
