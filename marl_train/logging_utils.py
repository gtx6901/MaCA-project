...
def log_train_scalars(
    ...
    *,
    ...
    writer.add_scalar("train/value_team_loss", float(stats.get("value_team_loss", 0.0)), env_steps)
    writer.add_scalar("train/value_contact_loss", float(stats.get("value_contact_loss", 0.0)), env_steps)
    ...
    writer.add_scalar("train/value_norm_std", float(stats.get("value_norm_std", 0.0)), env_steps)
    writer.add_scalar("train/value_norm_updated", float(stats.get("value_norm_updated", 0.0)), env_steps)
