...
class RLFighter:
    def __init__(
            self,
            n_actions,
            model_path='model/simple/model.pkl',
    ):
        ...
        if self.gpu_enable:
            ...
            self.target_net.load_state_dict(torch.load(self.model_path, map_location=lambda storage, loc: storage))
