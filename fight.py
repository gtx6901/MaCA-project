...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent1", type=str, default="selfrule", help='agent 1 name, only name, not path')
    parser.add_argument("--agent2", type=str, default="selfrule", help='agent 2 name, only name, not path')
    parser.add_argument("--round", type=int, default=100, help='play rounds')
    parser.add_argument("--fps", type=float, default=0, help='display fps')
    parser.add_argument("--max_step", type=int, default=2000, help='max step in a round')
    ...
    agent1_path = 'agent/' + args.agent1 + '/agent1.py'
    agent2_path = 'agent/' + args.agent2 + '/agent.py'
    agent1_import_path = 'agent.' + args.agent1 + '.agent3'
    agent2_import_path = 'agent.' + args.agent2 + '.agent1'
